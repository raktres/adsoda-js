...
describe('space test', () => {
  ...
  test('test JSON', () => {
    const jsontxt =
      '{ "name" : "space" , "dimension" : 2 ,  "solids" : [ { "name" : "sfb" , "dimension" : 2 ,   "color" : "000000" , "faces" : [ { "face" : [-1,-6,78] },{ "face" : [-3,1,25] },{ "face" : [2,6,-70] },{ "face" : [2,-1,0] }]},{ "name" : "sfr" , "dimension" : 2 ,        "color" : "000000" , "faces" : [ { "face" : [3,-2,11] },{ "face" : [-4,-3,42] },{ "face" : [-3,-1,24] },{ "face" : [4,6,-46] }]},{ "name" : "sfg" , "dimension" : 2 ,        "color" : "000000" , "faces" : [ { "face" : [1,-2,0] },{ "face" : [-1,0,14] },{ "face" : [-1,3,8] },{ "face" : [4,1,-45] }]}]}'
